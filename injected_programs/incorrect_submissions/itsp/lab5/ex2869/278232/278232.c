...
int main()
{
  _function_1_1();
  {
    ...
    int _int_1 = _int_0;
    scanf("%d", &_int_0);
    for (_int_2 = _int_0; _loop_3_2(_int_1, _int_0, _int_2), _int_2 <= _int_0; _int_2 = _int_2 + 1)
    {
      for (_int_3 = _int_0; _loop_5_3(_int_1, _int_0, _int_2, _int_3), _int_3 <= _int_0; _int_3 = _int_3 + 1)
      {
        if (_int_3 < _int_2)
        {

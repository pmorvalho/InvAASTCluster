...
int main()
{
  _function_1_1();
  {
    ...
    if (_int_2 == 1)
    {
      _if_3_12(_int_0, _int_1, _int_2);
      {
        for (_int_3 = 1; _loop_5_13(_int_0, _int_1, _int_2, _int_3), _int_3 <= _int_1; _int_3++)
        {
          printf("%d", _int_0);
    ...
    if (_int_1 == 1)
    {
      ...
      {
        for (_int_4 = 1; _loop_5_17(_int_0, _int_1, _int_2, _int_3, _int_4), _int_4 <= _int_2; _int_4++)
        {
          printf("%d\n", _int_0);

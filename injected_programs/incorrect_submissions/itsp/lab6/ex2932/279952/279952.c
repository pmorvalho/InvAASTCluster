...
int main()
{
  _function_1_1();
  {
    ...
    if (_int_0 > _int_1)
    {
      ...
      {
        int _int_2 = 0;
        while (_loop_5_5(_int_0, _int_1, _array_int_0, _int_2), _int_2 < _int_0)
        {
    ...
    {
      _else_3_15(_int_0, _int_1, _array_int_0, _array_int_1);
      {
        int _int_2;
        ...
        for (_int_2 = _int_0; _loop_5_10(_int_0, _int_1, _array_int_0, _array_int_1, _int_2), _int_2 <= _int_1; _int_2++)
        {
          ...
          for (int j = 1; _loop_7_11(_int_0, _int_1, _array_int_0, _array_int_1, _int_2, _int_3), j <= _int_0; j++)
          {
            ...
            _scope_8_12(_int_0, _int_1, _array_int_0, _array_int_1, _int_2, _int_3);
          }

          _int_3 = _array_int_1[_int_2];
          _scope_6_13(_int_0, _int_1, _array_int_0, _array_int_1, _int_2, _int_3);
        }

        printf("%d", _array_int_1[_int_1]);
        _scope_4_14(_int_0, _int_1, _array_int_0, _array_int_1, _int_2);
      }
    }

    {
      _return_3_16(_int_0, _int_1, _array_int_0, _array_int_1);
      return 0;
    }
    _scope_2_17(_int_0, _int_1, _array_int_0, _array_int_1);
  }
}

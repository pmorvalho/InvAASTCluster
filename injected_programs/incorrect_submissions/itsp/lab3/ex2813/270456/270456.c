...
int main()
{
  _function_1_1();
  {
    ...
    float _float_4 = ((_float_1 - _float_3) * (_float_0 * _float_2)) / ((_float_1 * _float_2) - (_float_0 * _float_3));
    float _float_5 = ((_float_0 - _float_2) * (_float_1 * _float_3)) / ((_float_0 * _float_3) - (_float_1 * _float_2));
    float _float_6 = (_float_0 * _float_3) - (_float_1 * _float_2);
    if (_float_6 == 0)
    {

...
int main()
{
  _function_1_1();
  {
    ...
    float _float_4;
    float _float_5;
    scanf("% %f %f %f", &_float_0, &_float_1, &_float_2, &_float_3);
    _float_4 = _float_1 / _float_0;
    _float_5 = _float_3 / _float_2;
    ...
    else
    {
      ...
      {
        printf("(%.3f,%.3f)", _float_6 == (((_float_0 * _float_2) * (_float_3 - _float_1)) / ((_float_0 * _float_3) - (_float_2 * _float_1))), _float_7 == (((_float_0 - _float_2) * (_float_1 * _float_3)) / ((_float_0 * _float_3) - (_float_2 * _float_1))));

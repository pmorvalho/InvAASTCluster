...
int main()
{
  _function_1_1();
  {
    ...
    _float_4 = (((_float_2 * _float_3) * _float_0) - ((_float_0 * _float_1) * _float_2)) / ((_float_0 * _float_3) - (_float_2 * _float_1));
    _float_5 = (((_float_0 * _float_1) * _float_3) - ((_float_2 * _float_3) * _float_1)) / ((_float_3 * _float_0) - (_float_1 * _float_2));
    if ((((_float_0 * _float_3) != (_float_1 * _float_2)) && (_float_4 != 0)) && (_float_5 != 0))
    {
    ...
    if ((_float_0 * _float_3) == (_float_1 * _float_2))
    {
      _if_3_7(_float_0, _float_1, _float_2, _float_3, _float_4, _float_5);
      {
        printf("INF");
        _scope_4_8(_float_0, _float_1, _float_2, _float_3, _float_4, _float_5);
      }
    }

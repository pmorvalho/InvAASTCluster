...
int main()
{
  _function_1_1();
  {
    ...
    _float_4 = (((_float_3 - _float_1) * _float_0) * _float_2) / ((_float_0 * _float_3) - (_float_2 * _float_1));
    _float_5 = (((_float_0 - _float_2) * _float_1) * _float_3) / ((_float_0 * _float_3) - (_float_2 * _float_1));

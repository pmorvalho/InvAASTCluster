...
int main()
{
  _function_1_1();
  {
    ...
    if ((((_int_0 + _int_1) + _int_2) - (2 * _int_3)) >= 0)
    {
      _if_3_16(_int_0, _int_1, _int_2, _int_3);
      {
        if ((((_int_0 * _int_0) + (_int_1 * _int_1)) + (_int_2 * _int_2)) == ((2 * _int_3) * _int_3))
        {
          _if_5_17(_int_0, _int_1, _int_2, _int_3);
          {
            printf("Right Triangle");
            _scope_6_18(_int_0, _int_1, _int_2, _int_3);
          }
        }
        else
        {
          _else_5_24(_int_0, _int_1, _int_2, _int_3);
          if ((((_int_0 * _int_0) + (_int_1 * _int_1)) + (_int_2 * _int_2)) >= ((2 * _int_3) * _int_3))
          {
            _if_6_19(_int_0, _int_1, _int_2, _int_3);
            {
              printf("Acute Triangle");
              _scope_7_20(_int_0, _int_1, _int_2, _int_3);
            }
          }
          else
          {
            _else_6_23(_int_0, _int_1, _int_2, _int_3);
            if ((((_int_0 * _int_0) + (_int_1 * _int_1)) + (_int_2 * _int_2)) <= ((2 * _int_3) * _int_3))
            {
              _if_7_21(_int_0, _int_1, _int_2, _int_3);
              {
                printf("Obtuse Triangle");
                _scope_8_22(_int_0, _int_1, _int_2, _int_3);
              }
            }
        ...
        _scope_4_25(_int_0, _int_1, _int_2, _int_3);
      }
    }

    {
      _return_3_26(_int_0, _int_1, _int_2, _int_3);
      return 0;
    }
    _scope_2_27(_int_0, _int_1, _int_2, _int_3);
  }
}

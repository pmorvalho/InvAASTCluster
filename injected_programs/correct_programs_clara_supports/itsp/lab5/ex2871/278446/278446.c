  ...
  _function_1_1();
  {
    ...
    for (_int_3 = 1; _loop_3_2(_int_0, _int_1, _int_2, _int_3), _int_3 <= _int_2; _int_3++)
    {
      for (_int_4 = 1; _loop_5_3(_int_0, _int_1, _int_2, _int_3, _int_4), _int_4 <= _int_1; _int_4++)
      {
        ...
        {
          _else_7_10(_int_0, _int_1, _int_2, _int_3, _int_4);
          ...
          {
            _else_8_9(_int_0, _int_1, _int_2, _int_3, _int_4);
            {
              printf(" ");
              _scope_9_8(_int_0, _int_1, _int_2, _int_3, _int_4);
            }
          }

        }

        _scope_6_11(_int_0, _int_1, _int_2, _int_3, _int_4);
      }

      printf("\n");
      _scope_4_12(_int_0, _int_1, _int_2, _int_3, _int_4);
    }

    {
      _return_3_13(_int_0, _int_1, _int_2, _int_3, _int_4);
      return 0;
    }
    _scope_2_14(_int_0, _int_1, _int_2, _int_3, _int_4);
  }
}

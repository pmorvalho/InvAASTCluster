...
int main()
{
  _function_1_10();
  {
    ...
    int _int_2;
    int _int_3;
    for (_int_1 = 2; _loop_3_11(_int_0, _int_1), _int_1 <= (_int_0 - 2); _int_1++)
    {
      _int_2 = check_prime(_int_1);
      _int_3 = check_prime(_int_0 - _int_1);
      if ((_int_2 == 1) && (_int_3 == 1))
      {
        _if_5_12(_int_0, _int_1, _int_2, _int_3);
        {
          _break_6_13(_int_0, _int_1, _int_2, _int_3);
          break;
        }
      }
    ...
    if ((_int_2 == 1) && (_int_3 == 1))
    {
      _if_3_15(_int_0, _int_1, _int_2, _int_3);
      {
        printf("Yes");
    ...
    {
      _else_3_18(_int_0, _int_1, _int_2, _int_3);
      {
        printf("No");
        _scope_4_17(_int_0, _int_1, _int_2, _int_3);
      }
    }

    {
      _return_3_19(_int_0, _int_1, _int_2, _int_3);
      return 0;
    }
    _scope_2_20(_int_0, _int_1, _int_2, _int_3);
  }
}

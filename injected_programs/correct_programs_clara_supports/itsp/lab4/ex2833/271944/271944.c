...
int main()
{
  _function_1_1();
  {
    ...
    scanf("%d", &_int_3);
    _int_4 = 0;
    for (_int_0 = 1; _loop_3_2(_int_0, _int_1, _int_2, _int_3, _int_4), _int_0 <= _int_3; _int_0++)
    {
      for (_int_1 = 1; _loop_5_3(_int_0, _int_1, _int_2, _int_3, _int_4), _int_1 <= _int_0; _int_1++)
      {
        for (_int_2 = 1; _loop_7_4(_int_0, _int_1, _int_2, _int_3, _int_4), _int_2 <= _int_1; _int_2++)
        {
    ...
    printf("Number of possible triangles is %d", _int_4);
    {

...
int main()
{
  _function_1_1();
  {
    ...
    if (_float_5 == (_float_2 * _float_2))
    {
      _if_3_4(_float_0, _float_1, _float_2, _float_3, _float_4, _float_5);
      {
    ...
    if (_float_5 > (_float_2 * _float_2))
    {
      _if_3_6(_float_0, _float_1, _float_2, _float_3, _float_4, _float_5);
      {
        printf("Point is outside the Circle.");
        _scope_4_7(_float_0, _float_1, _float_2, _float_3, _float_4, _float_5);
      }
    }

    {
      _return_3_8(_float_0, _float_1, _float_2, _float_3, _float_4, _float_5);
      return 0;
    }
    _scope_2_9(_float_0, _float_1, _float_2, _float_3, _float_4, _float_5);
  }
}

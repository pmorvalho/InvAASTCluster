...
int main()
{
  _function_1_1();
  {
    ...
    else
    {
      ...
      if ((((_int_0 * _int_0) < ((_int_2 * _int_2) + (_int_1 * _int_1))) && ((_int_1 * _int_1) < ((_int_0 * _int_0) + (_int_2 * _int_2)))) && ((_int_2 * _int_2) < ((_int_0 * _int_0) + (_int_1 * _int_1))))
      {
      ...
      else
      {
        ...
        if ((((_int_1 * _int_1) == ((_int_0 * _int_0) + (_int_2 * _int_2))) || ((_int_2 * _int_2) == ((_int_1 * _int_1) + (_int_0 * _int_0)))) || ((_int_0 * _int_0) == ((_int_1 * _int_1) + (_int_2 * _int_2))))
        {

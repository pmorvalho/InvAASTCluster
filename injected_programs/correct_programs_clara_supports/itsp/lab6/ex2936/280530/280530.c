...
int main()
{
  _function_1_1();
  {
    ...
    for (_int_2 = 0; _loop_3_4(_int_0, _int_1, _int_2, _array_int_0), _int_2 <= (_int_1 - 1); _int_2++)
    {
      for (_int_3 = 0; _loop_5_5(_int_0, _int_1, _int_2, _array_int_0, _int_3), _int_3 <= (_int_1 - 1); _int_3++)
      {
        if ((_array_int_0[_int_2] == _array_int_0[_int_3]) && (_int_2 != _int_3))
        {
          _if_7_6(_int_0, _int_1, _int_2, _array_int_0, _int_3);
          {
            _int_0 = 1;
      ...
      _scope_4_9(_int_0, _int_1, _int_2, _array_int_0, _int_3);
    }

    if (_int_0 == 1)
    {
      _if_3_10(_int_0, _int_1, _int_2, _array_int_0, _int_3);
      {
        printf("YES");
    ...
    else
    {
      ...
      {
        printf("NO");
        _scope_4_12(_int_0, _int_1, _int_2, _array_int_0, _int_3);
      }
    }

  ...
  _function_1_1();
  {
    ...
    for (_int_4 = 0; _loop_3_4(_int_0, _int_1, _int_2, _array_int_0, _int_3, _int_4), _int_4 <= (_int_1 - _int_3); _int_4++)
    {
      for (_int_5 = _int_4; _loop_5_5(_int_0, _int_1, _int_2, _array_int_0, _int_3, _int_4, _int_5), _int_5 < (_int_4 + _int_3); _int_5++)
      {
        ...
        _scope_6_6(_int_0, _int_1, _int_2, _array_int_0, _int_3, _int_4, _int_5);
      }

      printf("%d\n", _int_0);
      _int_0 = 0;
      _scope_4_7(_int_0, _int_1, _int_2, _array_int_0, _int_3, _int_4, _int_5);
    }

    {
      _return_3_8(_int_0, _int_1, _int_2, _array_int_0, _int_3, _int_4, _int_5);
      return 0;
    }
    _scope_2_9(_int_0, _int_1, _int_2, _array_int_0, _int_3, _int_4, _int_5);
  }
}
